  ...
  return (
    <div className="min-h-screen bg-black text-white font-inter">
      ...
      <main className=" mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-6 text-[#E8D1FF]">Terms & Condition</h1>
        ...
        <h2 className="text-3xl font-bold mb-6 text-[#E8D1FF]">Definitions</h2>
        <p className="text-gray-300 leading-relaxed mb-6">
          We strive to ensure high uptime but do not guarantee uninterrupted service. Limitation of Liability.
        </p>
