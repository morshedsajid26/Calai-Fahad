    ...
    >
      <Container>
        <motion.div
          ...
          className="mx-auto bg-[#02060F]/80 backdrop-blur-xl border border-[#1C398E]/40 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col md:flex-row relative overflow-hidden justify-between"
        >
          {/* Left Dark Section */}
          <motion.div
            ...
            className="bg-gradient-to-br from-[#59168B]/20 to-[#1C398E]/20 border border-[#59168B]/30 relative overflow-hidden rounded-[1.5rem] p-8 md:p-10 w-full md:w-[40%] flex flex-col"
          >
            <div className="relative z-10">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-center gap-4 text-gray-200">
                  <div className="w-10 h-10 rounded-full bg-[#59168B]/30 flex items-center justify-center shrink-0 border border-[#C27AFF]/30">
                    <FiMapPin className="text-lg text-[#00D3F3]" />
                  </div>
                  <span className="text-sm font-medium">
