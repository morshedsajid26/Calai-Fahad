...
const HowItWorks = () => {
  const steps = [
    {
      ...
      description: "Calai speaks naturally with your customers, helping them place orders without waiting.",
      slogan: "From menu questions to special requests — Calai handles the conversation.",
      bg: "bg-[#9810FA]",
      list: null,
    },
    {
    ...
    },
    {
      ...
      description: "Orders are organised clearly and sent directly to your printer. Customers receive a confirmation email and have the ability to pay via card.",
      slogan: null,
      bg: "bg-[#06B6D4]",
      list: null,
    },
  ...
  return (
    <section id="how-it-works" className="py-20 relative bg-gradient-to-b from-transparent via-[#1C398E]/5 to-[#59168B]/10">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          {steps.map((step, index) => (
            ...
            >
              {/* Background Glow */}
              <div className={`absolute -top-10 -right-10 w-32 h-32 ${step.bg} blur-[60px] opacity-20 group-hover:opacity-40 transition-opacity`} />
              
              <div className={`${step.bg} w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg shrink-0`}>
                {step.icon}
              </div>
              ...
              {step.list && (
                <ul className="flex flex-col gap-3 mt-2">
                  {step.list.map((item, i) => (
                    <li key={i} className="flex items-center gap-3 text-[#E2E4EB] font-inter text-[15px]">
