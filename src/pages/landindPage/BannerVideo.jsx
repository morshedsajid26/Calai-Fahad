      ...
      <div className="relative w-full max-w-[480px] pt-8 pl-4 pr-12 pb-20 font-inter">
        ...
        >
          <div className="flex gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#00D3F3] animate-pulse" style={{animationDelay: '0ms'}}></span>
            <span className="w-1.5 h-1.5 rounded-full bg-[#00D3F3] animate-pulse" style={{animationDelay: '150ms'}}></span>
            <span className="w-1.5 h-1.5 rounded-full bg-[#00D3F3] animate-pulse" style={{animationDelay: '300ms'}}></span>
          </div>
          <span className="text-gray-400 font-mono text-xs tracking-wide">AI processing order...</span>
        </motion.div>
        ...
        <div className="relative z-10 w-full bg-[#060B12]/95 backdrop-blur-xl border border-[#003B46] rounded-3xl p-5 md:p-7 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-[#27C93F] text-[11px] md:text-xs font-medium">Active</div>
            </div>
          </div>
          ...
          <div className="bg-[#0A131C] border border-[#003B46] rounded-2xl p-5 mb-5 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-tr from-[#59168B] to-[#00D3F3] flex items-center justify-center shadow-lg relative overflow-hidden">
                  <svg className="w-7 h-7 text-black/40 mt-3" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                </div>
                <div>
                  <h3 className="text-white font-bold text-base md:text-lg mb-0.5">Incoming Call</h3>
                  <p className="text-gray-400 text-xs md:text-sm font-medium">+880 1712-345678</p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-5 mb-7">
              ...
              <span className="text-gray-400 font-mono text-xs tracking-wider">AI Speaking...</span>
            </div>

            {/* Stats row */}
            <div className="flex justify-between items-end pr-2 md:pr-4">
              <div>
                <div className="text-white font-bold text-2xl md:text-3xl leading-none mb-1.5">02:34</div>
                <div className="text-gray-500 text-[10px] md:text-[12px] font-medium">Duration</div>
              </div>
              <div>
                <div className="text-[#00D3F3] font-bold text-2xl md:text-3xl leading-none mb-1.5">98%</div>
                <div className="text-gray-500 text-[10px] md:text-[12px] font-medium">Confidence</div>
              </div>
              <div className="flex flex-col items-center">
                <div className="text-[#27C93F] font-bold text-2xl md:text-3xl leading-none mb-1.5">✓</div>
                <div className="text-gray-500 text-[10px] md:text-[12px] font-medium">Order Ready</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4">
            <div className="bg-[#0A131C] border border-[#003B46]/60 rounded-xl p-3 md:p-4 flex flex-col items-center justify-center">
              <span className="text-[#00D3F3] font-bold italic text-xl md:text-2xl mb-1">127</span>
              <span className="text-gray-500 text-[10px] md:text-[11px] font-medium whitespace-nowrap">Today's Calls</span>
            </div>
            <div className="bg-[#0A131C] border border-[#3A1E4B]/80 rounded-xl p-3 md:p-4 flex flex-col items-center justify-center">
              <span className="text-[#AD46FF] font-bold italic text-xl md:text-2xl mb-1">94</span>
              <span className="text-gray-500 text-[10px] md:text-[11px] font-medium">Orders</span>
            </div>
            <div className="bg-[#0A131C] border border-[#164627]/80 rounded-xl p-3 md:p-4 flex flex-col items-center justify-center">
              <span className="text-[#27C93F] font-bold italic text-xl md:text-2xl mb-1">99.9%</span>
              <span className="text-gray-500 text-[10px] md:text-[11px] font-medium">Uptime</span>
            </div>
          </div>
        ...
        >
          <div className="flex gap-3 items-center mb-5">
            ...
            <div>
              <h4 className="text-white font-bold text-[13px] md:text-sm">Order Confirmed</h4>
              <p className="text-gray-400 text-[10px] md:text-[11px]">Email sent to customer</p>
            </div>
          </div>
