    ...
    <div className="">
      ...
      <form className="w-full flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between mt-1 px-1">
          ...
          <Link to="/auth/reset/password" className="text-[12px] text-white hover:text-[#2563EB] transition-colors">
            Forgot Password?
          </Link>
        </div>
        ...
        <button 
          type="submit"
          className="w-full mt-4 bg-[#090E20] text-white text-sm font-medium py-3.5 rounded-full border border-[#1D4ED8] shadow-[0_0_20px_rgba(29,78,216,0.25)] hover:shadow-[0_0_25px_rgba(29,78,216,0.4)] transition-all"
        >
          Sign in
        </button>
      </form>
